...
RUN apt-get -y install imagemagick x11-apps libcurl4 libgbm1 libgtk-3-0 libnspr4
...
RUN wget https://oss.npmmirror.com/dist/chromedriver/112.0.5615.28/chromedriver_linux64.zip
